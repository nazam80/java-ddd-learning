...
public class Starter {
    ...
    private static final String MOOC_APPLICATION = "mooc";
    ...
    public static void main(String[] args) {
        ...
        boolean isApiCommand    = commandName.equals(API_COMMAND);
    ...
    private static void ensureCommandExist(String applicationName, String commandName) {
        if (!API_COMMAND.equals(commandName) && !commands().containsKey(commandKey(applicationName, commandName))) {
            throw new RuntimeException(String.format(
    ...
    private static HashMap<String, Class<?>> applications() {
        ...
        applications.put(MOOC_APPLICATION, MoocBackendApplication.class);
